...
var TablePro = function (_Component) {
  _inherits(TablePro, _Component);

  function TablePro(props) {
    _classCallCheck(this, TablePro);

    var _this = _possibleConstructorReturn(this, (TablePro.__proto__ || Object.getPrototypeOf(TablePro)).call(this, props));
    ...
    value: function renderSearchBar() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'form-control mr-sm-2', type: 'text', placeholder: 'Search', value: this.state.searchText, onChange: this.handleChangeSearchBar.bind(this) })
        )
      );
    }
  }, {
    key: 'handleChangeSearchBar',
    value: function handleChangeSearchBar(event) {
